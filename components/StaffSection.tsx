    ...
    <section id="staff" className="bg-axBlack py-20 lg:py-28">
      <div className="section-shell">
        ...
        <div className="grid grid-cols-2 gap-5 md:grid-cols-4">
          {staff.map((member) => (
            <article key={member.name} className="rounded-[8px] border border-white/10 bg-white/[0.04] p-5">
              <div className="flex items-center gap-4">
                ...
                <span className="inline-flex rounded-full bg-[#C9A84C15] px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-[#C9A84C]">
                  {member.role}
                </span>
              </div>
